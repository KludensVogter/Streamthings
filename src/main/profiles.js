...
function defaultProfile() {
  return {
    ...
    targetWindow: '',
    commands: [
      { id: 'forward', aliases: ['w', 'up'], type: 'key', keys: ['w'], duration: 0.4, allowHold: true, maxHold: 3, info: 'Walk forward' },
      { id: 'back', aliases: ['s', 'down'], type: 'key', keys: ['s'], duration: 0.4, allowHold: true, maxHold: 3, info: 'Walk backwards' },
      { id: 'left', aliases: ['a'], type: 'key', keys: ['a'], duration: 0.3, allowHold: true, maxHold: 3, info: 'Strafe left' },
      { id: 'right', aliases: ['d'], type: 'key', keys: ['d'], duration: 0.3, allowHold: true, maxHold: 3, info: 'Strafe right' },
      { id: 'sprint', aliases: ['run'], type: 'key', keys: ['shift', 'w'], duration: 1, allowHold: true, maxHold: 4, info: 'Sprint forward' },
      { id: 'jump', aliases: ['space'], type: 'key', keys: ['space'], duration: 0.1, info: 'Jump' },
      { id: 'crouch', aliases: ['duck', 'ctrl'], type: 'key', keys: ['ctrl'], duration: 0.5, allowHold: true, maxHold: 3, info: 'Crouch' },
      ...
      { id: 'aim', aliases: ['ads'], type: 'mouse', button: 'right', duration: 0.3, allowHold: true, maxHold: 3, info: 'Aim down sights' },
